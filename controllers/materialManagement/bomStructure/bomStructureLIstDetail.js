...
export const revertBomStructureListDetail = async (req, res) => {
    ...
    try {
        ...
        const pendingToCreate = detailsToRevert.map(detail => ({
            ...
            MATERIAL_ITEM_REQUIREMENT_QTY: Number(detail.ORDER_QUANTITY) * Number(detail.PRODUCTION_CONSUMPTION_PER_ITEM),
    ...
    try {
        ...
        const detailToCreate = pendingDimensions.map((pd, idx) => {
            ...
            return {
                ...
                MATERIAL_ITEM_REQUIREMENT_QUANTITY: itemDimension?.DIMENSION_ID ? limitFloating(pd.MATERIAL_ITEM_REQUIREMENT_QTY) : 0,
