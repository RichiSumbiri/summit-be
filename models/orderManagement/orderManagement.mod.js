...
LEFT JOIN order_po_header oph ON oph.ORDER_ID = opl.ORDER_NO 
LEFT JOIN product_item pi2 ON pi2.PRODUCT_ID = opl.PRODUCT_ID 
WHERE 
  opl.SUMMIT_FLAG ='1' AND
  opl.MANUFACTURING_COMPANY = :mfgCompany AND
  opl.PO_STATUS = :poStatus
`;

/*
{
  MANUFACTURING_COMPANY: 'SBR',
  MO_AVAILABILITY: 'Yes',
  DATE_RANGE_TYPE: '---',
  ORDER_TYPE_CODE: 'BLK',
  PO_APPROVAL_STAGE: 'Active',
  LIST_STATUS: [
    { STATUS: 'Open' },
    { STATUS: 'Confirmed' },
  ...
  MANUFACTURING_SITE: 'SBR_01',
  PRODUCTION_MONTH: '2025-09',
  CUSTOMER_ID: 'CTC0000001',
  CUSTOMER_DIVISION_ID: '3',
  CUSTOMER_SEASON_ID: '1',
  PRODUCT_ID: 'PID0000001'
}
