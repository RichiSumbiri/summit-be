...
SELECT 
    ...
    SUM(CASE WHEN (saa.keterangan = 'H' AND saa.actual_calendar = 'HL') THEN 1 ELSE 0 END) AS H_NH, -- masuk di hari libur
    ...
    SUM(CASE WHEN (saa.keterangan <> 'H' AND saa.keterangan <> 'DL' AND saa.keterangan <> 'CH' AND saa.keterangan <> 'CG' )  THEN 1 ELSE 0 END) AS days_abs, -- jumlah tidak masuk kerja
    ...
    SUM(CASE WHEN (saa.keterangan = 'CH' OR  saa.keterangan = 'CG') THEN 1 ELSE 0 END) AS CH, -- cuti hami/melahirkan
    ...
    SUM(CASE WHEN saa.idGroup = 2 AND  saa.keterangan = 'H' THEN 1 ELSE 0 END) AS S2,
    SUM(CASE WHEN saa.idGroup = 3 AND  saa.keterangan = 'H' THEN 1 ELSE 0 END) AS S3, 
