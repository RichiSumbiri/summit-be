...
WHERE a.SCH_SITE = :site AND a.SCH_ID IN  (
 ...
 OR a.SCH_START_PROD BETWEEN  :startDate AND :endDate
OR a.SCH_FINISH_PROD BETWEEN  :startDate AND :endDate
ORDER BY a.SCH_ID_SITELINE, a.SCH_START_PROD,  a.SCH_FINISH_PROD, a.SCH_ADD_DATE`;
