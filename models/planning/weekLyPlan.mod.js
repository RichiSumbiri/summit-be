...
b.NEW_TARGET_PCD, b.NEW_PLAN_EXFACTORY_DATE,  b.NEW_FINAL_DELIVERY_DATE, a.ENDLINE_VER
FROM weekly_prod_schedule a   
...
ORDER BY a.SCH_ID_SITELINE, a.SCH_START_PROD,  a.SCH_FINISH_PROD, a.SCH_MOD_DATE`;
...
export const WeeklyProSchd = db.define(
  "weekly_prod_schedule",
  {
    ...
    ENDLINE_VER: { type: DataTypes.INTEGER },
...
LEFT JOIN  (
  ...
  AND n.SCH_ID <> :schId
	GROUP BY  n.SIZE_CODE, n.PACKING_METHOD, IFNULL(o.NEW_PLAN_EXFACTORY_DATE, o.PLAN_EXFACTORY_DATE), n.PDM_ID
...
LEFT JOIN  (
  ...
  AND n.SCH_ID = :schId
	GROUP BY  n.SIZE_CODE, n.PACKING_METHOD ,  IFNULL(o.NEW_PLAN_EXFACTORY_DATE, o.PLAN_EXFACTORY_DATE), n.PDM_ID
) nb ON nb.SIZE_CODE = a.SIZE_CODE AND nb.PACKING_METHOD = a.PACKING_METHOD AND nb.EX_FACTORY = IFNULL(b.NEW_PLAN_EXFACTORY_DATE, b.PLAN_EXFACTORY_DATE)  
  AND nb.PDM_ID = a.PDM_ID
...
export const QryCheckOutput = `SELECT DISTINCT a.ENDLINE_ACT_SCHD_ID, a.ENDLINE_ACT_RPR_SCHD_ID
FROM qc_endline_output a
WHERE a.ENDLINE_ACT_SCHD_ID = :schdId OR  a.ENDLINE_ACT_RPR_SCHD_ID = :schdId`;
...
FROM item_line_running a
LEFT JOIN scheduel_vs_actual b ON a.ID_SITELINE = b.SCHD_ID_SITELINE
WHERE b.SCHD_PROD_DATE = DATE_SUB(CURDATE(), INTERVAL 1 DAY) -- AND a.ID_SITELINE = 'SLD0000172'`;
