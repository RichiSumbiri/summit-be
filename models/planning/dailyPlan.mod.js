...
export const QueryCheckSchdScan = `	SELECT * FROM (
	...
	b.PRODUCT_ITEM_DESCRIPTION, b.ORDER_STYLE_DESCRIPTION, f.SIZE_CODE, SUM(f.SCH_SIZE_QTY) SCH_SIZE_QTY, b.PRODUCTION_MONTH, 
...
export const QryFinSprMrktIn = `SELECT  N.BUYER_CODE, N.ORDER_NO, N.PRODUCT_TYPE, N.BUYER_PO, N.MO_NO,N.ORDER_REF,
...
N.PRODUCTION_MONTH, N.PLAN_EXFACTORY_DATE, N.MOL_STATUS
FROM  (
	...
	c.ITEM_COLOR_NAME ORDER_COLOR, b.ORDER_SIZE, b.ORDER_QTY, c.ORDER_STYLE_DESCRIPTION ORDER_STYLE, b.SITE_LINE SITE_LINE_FX, 
   	...
   	IFNULL(c.NEW_MANUFACTURING_SITE, c.MANUFACTURING_SITE) MANUFACTURING_SITE, b.MOL_STATUS
...
export const QryFinSprMrktOut = `SELECT  N.BUYER_CODE, N.ORDER_NO, N.PRODUCT_TYPE, N.BUYER_PO, N.MO_NO,N.ORDER_REF,
N.ORDER_COLOR, N.ORDER_SIZE, N.ORDER_QTY, N.ORDER_STYLE, N.BARCODE_SERIAL, N.SITE_LINE_FX, b.SITE_NAME, b.LINE_NAME, N.MANUFACTURING_SITE,
...
export const QryFinMolIn = `SELECT  N.BUYER_CODE, N.ORDER_NO, N.PRODUCT_TYPE, N.BUYER_PO, N.MO_NO,N.ORDER_REF,
N.ORDER_COLOR, N.ORDER_SIZE, N.ORDER_QTY, N.ORDER_STYLE, N.BARCODE_SERIAL, N.SITE_LINE_FX, b.SITE_NAME, b.LINE_NAME, N.MANUFACTURING_SITE,
N.PRODUCTION_MONTH, N.PLAN_EXFACTORY_DATE
FROM  (
	SELECT DISTINCT a.BARCODE_SERIAL, b.BUYER_CODE, b.ORDER_NO, b.PRODUCT_TYPE, b.BUYER_PO, SUBSTRING_INDEX(b.MO_NO,',',-1) MO_NO, c.ORDER_REFERENCE_PO_NO ORDER_REF,
...
export const QryFinMolOut = `SELECT  N.BUYER_CODE, N.ORDER_NO, N.PRODUCT_TYPE, N.BUYER_PO, N.MO_NO,N.ORDER_REF,
N.ORDER_COLOR, N.ORDER_SIZE, N.ORDER_QTY, N.ORDER_STYLE, N.BARCODE_SERIAL, N.SITE_LINE_FX, b.SITE_NAME, b.LINE_NAME, N.MANUFACTURING_SITE,
N.PRODUCTION_MONTH, N.PLAN_EXFACTORY_DATE
FROM  (
	SELECT DISTINCT a.BARCODE_SERIAL, b.BUYER_CODE, b.ORDER_NO, b.PRODUCT_TYPE, b.BUYER_PO, SUBSTRING_INDEX(b.MO_NO,',',-1) MO_NO, c.ORDER_REFERENCE_PO_NO ORDER_REF,
...
export const QueryCheckSchdScanSpesifik = `SELECT a.SCHD_ID, a.SCH_ID, f.PDM_ID, a.SCHD_PROD_DATE,
		b.ORDER_NO, b.MO_NO, d.ID_SITELINE,  d.SITE_NAME, d.LINE_NAME, b.MANUFACTURING_SITE,
		b.CUSTOMER_NAME, b.PRODUCT_ITEM_CODE, b.ORDER_REFERENCE_PO_NO, b.ITEM_COLOR_CODE, b.ITEM_COLOR_NAME, 
		b.PRODUCT_ITEM_DESCRIPTION, b.ORDER_STYLE_DESCRIPTION, f.SIZE_CODE, SUM(f.SCH_SIZE_QTY) SCH_SIZE_QTY, b.PRODUCTION_MONTH, 
		if(b.NEW_PLAN_EXFACTORY_DATE, b.NEW_PLAN_EXFACTORY_DATE, b.PLAN_EXFACTORY_DATE) PLAN_EXFACTORY_DATE
