...
na.CUT_ID, na.CUT_SCH_ID, na.CUT_ID_CAPACITY, na.CUT_SITE_NAME, na.LINE_NAME,
b.ORDER_REFERENCE_PO_NO, b.ORDER_NO, b.CUSTOMER_NAME, b.CUSTOMER_PROGRAM, b.PRODUCT_ITEM_CODE, 
b.ITEM_COLOR_CODE,  b.ITEM_COLOR_NAME, b.ORDER_STYLE_DESCRIPTION, b.MO_QTY,CUT_SCH_QTY, 
na.CUT_SIZE_TYPE,
...
// )  `;
export const qryGetCutSchSize = `SELECT 
a.CUT_ID_SIZE, a.CUT_ID, a.CUT_SCH_ID, a.CUT_SEW_SIZE_CODE, a.CUT_SEW_SCH_QTY, a.CUT_ID_SITELINE ,
...
ORDER BY  a.CUT_ID_SITELINE, a.CUT_SCH_ID`;
