...
export const qryCutingSchDetailReal = `SELECT 
n.CUT_SCH_ID, n.CUT_SCH_DATE CUT_LOAD_DATE, n.CUT_SEW_SIZE_CODE, n.CUT_STATUS, SUM(n.CUT_SCH_QTY)  CUT_SCH_QTY, SUM(n.LOADING_QTY) LOADING_QTY
FROM (
    SELECT DISTINCT
      a.CUT_SCH_ID, a.CUT_SCH_DATE, b.CUT_SEW_SIZE_CODE, a.CUT_STATUS, a.CUT_SCH_QTY , 0 LOADING_QTY
    FROM cuting_schedule_detail a 
    LEFT JOIN cuting_loading_sch_size b ON b.CUT_ID_SIZE = a.CUT_ID_SIZE
    LEFT JOIN item_siteline st ON a.CUT_ID_SITELINE = st.ID_SITELINE 
    WHERE a.CUT_SCH_DATE BETWEEN :startDate AND :endDate AND st.SITE_NAME = :site
    GROUP BY a.CUT_SCH_ID, a.CUT_SCH_DATE, b.CUT_SEW_SIZE_CODE
) n GROUP BY n.CUT_SCH_ID, n.CUT_SCH_DATE, n.CUT_SEW_SIZE_CODE`;
...
b.ORDER_REFERENCE_PO_NO ORDER_REF, b.ORDER_NO, b.CUSTOMER_NAME, b.MO_NO,  b.PRODUCT_ITEM_CODE, 
...
n.SITE_NAME, n.ORDER_NO, n.MO_NO, n.ITEM_COLOR_CODE, n.CUT_SEW_SIZE_CODE, 
...
GROUP BY  n.ORDER_NO, n.ITEM_COLOR_CODE, n.CUT_SEW_SIZE_CODE `;
