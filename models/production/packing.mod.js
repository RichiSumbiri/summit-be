...
export const qryGetRowDtl = `SELECT a.ROWID, a.PACKPLAN_ID, a.ROW_TYPE, a.BOX_ID, a.CTN_START, a.CTN_END, a.PO_INDEX, a.COL_INDEX,
 ...
 IFNULL(a.PO_ITEM,d.PO_ITEM) PO_ITEM, IFNULL(a.ARTICLE, d.ARTICLE_GENERIC) ARTICLE, IFNULL(d.UPC_CODE, a.UPC_CODE) UPC_CODE
 FROM 
...
) d ON d.PO_NUMBER = a.BUYER_PO AND a.BUYER_COLOR_CODE = d.COLOR_CODE AND a.SIZE_CODE = d.SIZE_CODE AND b.PACKING_METHODE = d.PACKING_METHODE 
-- AND FIND_IN_SET( LEFT(d.ARTICLE_GENERIC,7), LEFT(b.PRODUCT_ITEM_CODE, 7)) > 0
WHERE a.PACKPLAN_ID = :ppid
