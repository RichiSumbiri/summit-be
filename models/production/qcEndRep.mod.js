export const QurTablPlanQcEndRep = `SELECT h.SCHD_ID, h.SCH_ID, h.SCHD_PROD_DATE, h.ID_SITELINE,  h.SITE_NAME, h.LINE_NAME, h.SHIFT, h.ORDER_REFERENCE_PO_NO, h.ORDER_STYLE_DESCRIPTION, 
...
FROM(
	SELECT 
	n.SCHD_ID, n.SCH_ID, n.SCHD_PROD_DATE, n.ID_SITELINE,  n.SITE_NAME, n.LINE_NAME, n.SHIFT,	n.ORDER_REFERENCE_PO_NO, n.ORDER_STYLE_DESCRIPTION,
	...
	FROM (
	    ...
	    a.SCHD_CAPACITY_ID, a.SCHD_DAYS_NUMBER, a.SCHD_QTY, b.ORDER_NO, b.CUSTOMER_NAME, b.CUSTOMER_DIVISION, b.PRODUCT_ITEM_CODE, b.ORDER_STYLE_DESCRIPTION,
...
export const qryUserQcEndName = `SELECT DISTINCT a.ENDLINE_ADD_ID, b.QC_NAME
FROM qc_endline_output a
LEFT JOIN qc_inspection_user b ON a.ENDLINE_ADD_ID = b.QC_USER_ID
