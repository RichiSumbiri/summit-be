...
FROM (
	...
	IF(COALESCE(i.BARCODE_SERIAL, '') != '', 1, NULL) AS GENERATE_BDL,
	IF(COALESCE(f.BARCODE_SERIAL, '') != '', 1, NULL) AS MOL_IN,
	IF(COALESCE(g.BARCODE_SERIAL, '') != '', 2, NULL) AS MOL_OUT,
	IF(COALESCE(h.BARCODE_SERIAL, '') != '', 3, NULL) AS SUP_IN,
	IF(COALESCE(b.BARCODE_SERIAL, '') != '', 4, NULL) AS SUP_OUT,
	IF(COALESCE(c.BARCODE_SERIAL, '') != '', 5, NULL) AS SEWING_IN,
	IF(COALESCE(d.BARCODE_SERIAL, '') != '', 6, NULL) AS SEWING_OUT,
	IF(COALESCE(e.BARCODE_SERIAL, '') != '', 7, NULL) AS PACKING_IN,
