...
a.PRODUCT_ITEM_CODE, a.ORDER_STYLE_DESCRIPTION PRODUCT_ITEM_DESCRIPTION, a.ITEM_COLOR_CODE, a.ITEM_COLOR_NAME
...
IFNULL(RFT, 0)+IFNULL(c.REPAIRED,0) GOOD
FROM(
	SELECT
		a.ENDLINE_ID_SITELINE,
		a.ENDLINE_PLAN_SIZE,
		CASE
			WHEN DATE(a.ENDLINE_ADD_TIME) <>  :schDate THEN a.ENDLINE_ACT_RPR_SCHD_ID
			ELSE a.ENDLINE_ACT_SCHD_ID END AS ENDLINE_ACT_SCHD_ID,
		CASE
			WHEN DATE(a.ENDLINE_ADD_TIME) <>  :schDate THEN DATE(a.ENDLINE_MOD_TIME)
			ELSE DATE(a.ENDLINE_ADD_TIME) END AS ENDLINE_SCHD_DATE,
		SUM(CASE
	...
	WHERE (a.ENDLINE_OUT_TYPE = 'RTT' OR (a.ENDLINE_OUT_TYPE = 'DEFECT' AND a.ENDLINE_REPAIR = 'Y'))
		...
		AND (DATE(a.ENDLINE_ADD_TIME) =:schDate  OR  DATE(a.ENDLINE_MOD_TIME) =:schDate )
		AND b.SITE_NAME = :sitename
		AND b.SHIFT = :shift
	GROUP BY DATE(a.ENDLINE_ADD_TIME), a.ENDLINE_ID_SITELINE, a.ENDLINE_ACT_SCHD_ID, a.ENDLINE_PLAN_SIZE
) c`;
