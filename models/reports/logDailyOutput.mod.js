...
SELECT h.SCHD_ID, h.SCH_ID, h.SCHD_PROD_DATE, h.ID_SITELINE,  h.SITE_NAME, h.LINE_NAME, h.SHIFT, h.SCHD_QTY,
        ...
        FROM(
		   ...
		   FROM (
		       ...
		       ACTUAL_MINUTE('Normal_A', a.SCHD_PROD_DATE, k.SHIFT_START_HOUR, k.SHIFT_END_HOUR, CURTIME(), e.PLAN_WH) ACT_MIN,
		       ...
		       p.NORMAL_OUTPUT, p.OT_OUTPUT, p.X_OT_OUTPUT, p.GROUP_ID
		           ...
		           LEFT JOIN mp_daily_detail m  ON m.SCHD_ID = a.SCHD_ID AND m.SHIFT = 'Normal_A' 
		           ...
		           WHERE a.SCHD_PROD_DATE = CURDATE()   AND  e.SHIFT = 'Normal_A' -- AND d.SITE_NAME = 'SBR_01' AND d.LINE_NAME = 'LINE-02'
            )n
        )h
    ) I
UNION ALL 
...
SELECT h.SCHD_ID, h.SCH_ID, h.SCHD_PROD_DATE, h.ID_SITELINE,  h.SITE_NAME, h.LINE_NAME, h.SHIFT, h.SCHD_QTY,
        ...
        (h.NORMAL_OUTPUT*h.PLAN_SEW_SMV) ACTUAL_EH, (h.ACT_MP*h.ACT_WH) ACTUAL_AH,
        (h.OT_OUTPUT*h.PLAN_SEW_SMV) ACTUAL_EH_OT, (h.ACT_MP_OT*h.ACT_WH_OT) ACTUAL_AH_OT,
        (h.X_OT_OUTPUT*h.PLAN_SEW_SMV) ACTUAL_EH_X_OT, (h.ACT_MP_X_OT*h.ACT_WH_X_OT)  ACTUAL_AH_X_OT, h.GROUP_ID
        FROM(
 			   SELECT n.SCHD_ID, n.SCH_ID, n.SCHD_PROD_DATE, n.ID_SITELINE,  n.SITE_NAME, n.LINE_NAME, n.SHIFT, n.SCHD_QTY,
		       n.ORDER_REFERENCE_PO_NO, n.SCHD_DAYS_NUMBER,
		       n.ORDER_NO, n.CUSTOMER_NAME, n.CUSTOMER_PROGRAM, n.PRODUCT_ITEM_CODE, 
		       ...
		       (n.PLAN_WH*n.ACT_MIN)/n.MAIN_WH ACT_WH, -- NEW FORMULA 
		       (n.PLAN_WH_OT*n.ACT_MIN_OT)/n.MAIN_WH_OT ACT_WH_OT,
		       (n.PLAN_WH_X_OT*n.ACT_MIN_XOT)/n.MAIN_WH_X_OT ACT_WH_X_OT, n.GROUP_ID
		   FROM (
		           SELECT a.SCHD_ID, a.SCH_ID, a.SCHD_PROD_DATE, e.ID_SITELINE,  d.SITE_NAME, d.LINE_NAME, e.SHIFT, 
		       ...
		       b.ITEM_COLOR_CODE,  b.ITEM_COLOR_NAME, b.ORDER_STYLE_DESCRIPTION,  
		       FIND_SMV(g.SMV_PLAN, c.ACTUAL_SEW_SMV,c.PLAN_SEW_SMV ) PLAN_SEW_SMV,
		       ACTUAL_MINUTE('Shift_A', a.SCHD_PROD_DATE, k.SHIFT_START_HOUR, k.SHIFT_END_HOUR, CURTIME(), e.PLAN_WH) ACT_MIN,
		       ACT_MIN_OT(a.SCHD_PROD_DATE, k.SHIFT_END_HOUR, e.TTL_WH_OT, CURTIME(), f.PLAN_WH_OT) ACT_MIN_OT,
		       ACT_MIN_OT(a.SCHD_PROD_DATE, k.SHIFT_HOURLY_OT2, e.TTL_WH_X_OT, CURTIME(), f.PLAN_WH_X_OT) ACT_MIN_XOT,
		       e.PLAN_WH MAIN_WH,
		       e.TTL_WH_OT MAIN_WH_OT,
		       ...
		       p.NORMAL_OUTPUT, p.OT_OUTPUT, p.X_OT_OUTPUT, p.GROUP_ID
		           ...
		           LEFT JOIN mp_daily_detail m  ON m.SCHD_ID = a.SCHD_ID AND m.SHIFT = 'Shift_A' 
		           -- left join ciew qcendlineoutput untuk mendapatkan output
		           LEFT JOIN (
		                  SELECT N.ENDLINE_ACT_SCHD_ID, N.ENDLINE_SCHD_DATE,  N.ENDLINE_SCH_ID, N.ENDLINE_ID_SITELINE, N.ENDLINE_LINE_NAME, N.GROUP_ID,
								SUM(N.ENDLINE_OUT_QTY) NORMAL_OUTPUT,
		           ...
		           WHERE a.SCHD_PROD_DATE = CURDATE()   AND  e.SHIFT = 'Shift_A' -- AND d.SITE_NAME = 'SBR_01' AND d.LINE_NAME = 'LINE-02'
            )n
        )h
    ) I
UNION ALL 
...
SELECT h.SCHD_ID, h.SCH_ID, h.SCHD_PROD_DATE, h.ID_SITELINE,  h.SITE_NAME, h.LINE_NAME, h.SHIFT, h.SCHD_QTY,
        ...
        FROM(
		   ...
		   FROM (
		       ...
		       b.ITEM_COLOR_CODE,  b.ITEM_COLOR_NAME, b.ORDER_STYLE_DESCRIPTION,  
		       FIND_SMV(g.SMV_PLAN, c.ACTUAL_SEW_SMV,c.PLAN_SEW_SMV ) PLAN_SEW_SMV,
		       ACTUAL_MINUTE('Shift_B', a.SCHD_PROD_DATE, k.SHIFT_START_HOUR, k.SHIFT_END_HOUR, CURTIME(), e.PLAN_WH) ACT_MIN,
		       ACT_MIN_OT(a.SCHD_PROD_DATE, k.SHIFT_END_HOUR, e.TTL_WH_OT, CURTIME(), f.PLAN_WH_OT) ACT_MIN_OT,
		       ACT_MIN_OT(a.SCHD_PROD_DATE, k.SHIFT_HOURLY_OT2, e.TTL_WH_X_OT, CURTIME(), f.PLAN_WH_X_OT) ACT_MIN_XOT,
		       e.PLAN_WH MAIN_WH,
		       e.TTL_WH_OT MAIN_WH_OT,
		       ...
		       p.NORMAL_OUTPUT, p.OT_OUTPUT, p.X_OT_OUTPUT, p.GROUP_ID
		           ...
		           LEFT JOIN 	(
                           ...
                           WHERE a.MP_DATE = CURDATE()   
                           AND b.SHIFT = 'Shift_B'  -- AND b.ID_SITELINE = 'SLD0000001' AND b.SITE_NAME = 'SBR_01'
                           AND c.SCHD_PROD_DATE = CURDATE()
		           ...
		           LEFT JOIN mp_daily_detail m  ON m.SCHD_ID = a.SCHD_ID AND m.SHIFT = 'Shift_B' 
		           -- left join ciew qcendlineoutput untuk mendapatkan output
		           LEFT JOIN (
		                  SELECT N.ENDLINE_ACT_SCHD_ID, N.ENDLINE_SCHD_DATE,  N.ENDLINE_SCH_ID, N.ENDLINE_ID_SITELINE, N.ENDLINE_LINE_NAME, N.GROUP_ID,
								SUM(N.ENDLINE_OUT_QTY) NORMAL_OUTPUT,
		           ...
		           WHERE a.SCHD_PROD_DATE = CURDATE()   AND  e.SHIFT = 'Shift_B' -- AND d.SITE_NAME = 'SBR_01' AND d.LINE_NAME = 'LINE-02'
            )n
        )h
    ) I`;
