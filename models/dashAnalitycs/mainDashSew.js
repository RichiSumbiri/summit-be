...
SELECT h.SCHD_ID, h.SCH_ID, h.SCHD_PROD_DATE, h.ID_SITELINE,  h.SITE_NAME, h.CUS_NAME, h.LINE_NAME, h.SHIFT, h.SCHD_QTY,
        ...
        h.WH_PERCENTAGE,
        h.PLAN_EH, h.PLAN_AH, h.PLAN_EH_OT, h.PLAN_AH_OT,  h.PLAN_EH_X_OT, h.PLAN_AH_X_OT,
        h.ACT_WH, h.ACT_WH_OT, h.ACT_WH_X_OT, h.ACTUAL_EH, 
        IFNULL(h.ACTUAL_AH,0) ACTUAL_AH,
        h.ACTUAL_EH_OT, 
        IFNULL(h.ACTUAL_AH_OT,0) ACTUAL_AH_OT,
        h.ACTUAL_EH_X_OT,
        IFNULL(h.ACTUAL_AH_X_OT,0) ACTUAL_AH_X_OT
        FROM(
...
I.*,
gl.SHIFT_START_HOUR STARTH, gl.SHIFT_END_HOUR ENDH, (I.ACT_TARGET/I.PLAN_WH)*I.WH_PERCENTAGE TPPM_NORMAL,
FIND_RTT(gl.SHIFT_START_HOUR, gl.SHIFT_END_HOUR, CURDATE(), I.ACT_TARGET, 	 ((I.ACT_TARGET/I.PLAN_WH)*I.WH_PERCENTAGE), :shift) RTT,
FIND_RTT_OT(gl.SHIFT_END_HOUR, DATE_ADD(gl.SHIFT_END_HOUR, INTERVAL I.PLAN_WH_OT MINUTE), CURDATE(), ACT_TARGET_OT, ACT_TARGET_OT/PLAN_WH_OT) RTT_OT, 
FIND_RTT_OT(gl.SHIFT_HOURLY_OT2, DATE_ADD(gl.SHIFT_END_HOUR, INTERVAL I.PLAN_WH_X_OT MINUTE), CURDATE(), ACT_TARGET_X_OT, ACT_TARGET_X_OT/PLAN_WH_X_OT) RTT_X_OT
FROM (
SELECT h.SCHD_ID, h.SCH_ID, h.SCHD_PROD_DATE, h.ID_SITELINE,  h.SITE_NAME, h.CUS_NAME, h.LINE_NAME, h.SHIFT, h.SCHD_QTY,
        h.ORDER_REFERENCE_PO_NO, h.SCHD_DAYS_NUMBER, 
        h.ORDER_NO, h.CUSTOMER_NAME, h.CUSTOMER_PROGRAM, h.PRODUCT_ITEM_CODE, 
...
SELECT n.* FROM ( 
 SELECT  
  ...
  WHERE 
    DATE(a.ENDLINE_ADD_TIME) = :schDate AND a.ENDLINE_ID_SITELINE = :idSiteline AND a.ENDLINE_OUT_UNDO IS NULL
...
( 
 SELECT  
  ...
  WHERE 
  a.ENDLINE_SCHD_DATE = :schDate AND a.ENDLINE_ID_SITELINE = :idSiteline AND a.ENDLINE_OUT_UNDO IS NULL
