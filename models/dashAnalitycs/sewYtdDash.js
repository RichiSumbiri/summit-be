export const QueryWeekRep = (params) => {
  ...
  IFNULL(n.ACT_MP_OT,0) ACT_MP_OT,
  IFNULL(n.ACT_MP_X_OT,0) ACT_MP_X_OT,
  IFNULL(n.ACT_MP_OT,0)+IFNULL(n.ACT_MP_X_OT,0) ACT_MP_ALL_OT,
  n.ACT_TARGET,
  n.ACT_TARGET_OT,
  n.ACT_TARGET_X_OT,
  n.NORMAL_OUTPUT,
  ...
  n.TOTAL_TARGET, 
  n.TOTAL_OUTPUT,
  IFNULL((n.ACT_TARGET_OT+n.ACT_TARGET_X_OT), 0) AS ACT_TARGET_ALL_OT,
  IFNULL((  n.OT_OUTPUT+n.X_OT_OUTPUT), 0) AS ALL_OUTPUT_OT,
  ...
  IFNULL(n.ACTUAL_EH_OT,0)+IFNULL(n.ACTUAL_EH_X_OT,0) TOTAL_ALL_EH_OT,
  IFNULL(n.ACTUAL_AH_OT,0)+IFNULL(n.ACTUAL_AH_X_OT,0) TOTAL_ALL_AH_OT,
  ...
  FROM (
      ...
      a.PLAN_SEW_SMV, a.ACT_MP, a.ACT_MP_OT, a.ACT_MP_X_OT, a.PLAN_WH, 
      a.ACT_TARGET,
      IFNULL(a.ACT_TARGET_OT, 0) ACT_TARGET_OT,
      IFNULL(a.ACT_TARGET_X_OT, 0) ACT_TARGET_X_OT,
      a.NORMAL_OUTPUT,
      IFNULL(a.OT_OUTPUT, 0) OT_OUTPUT,
      IFNULL(a.X_OT_OUTPUT, 0) X_OT_OUTPUT,
      a.TOTAL_TARGET, 
      a.TOTAL_OUTPUT, 
      a.ACTUAL_EH, 
      a.ACTUAL_EH_OT,
...
export const QueryMonthRep = (params) => {
  ...
  n.ID_SITELINE,  n.SITE_NAME, n.CUS_NAME, n.LINE_NAME, 
  n.ACT_MP,
  IFNULL(n.ACT_MP_OT,0) ACT_MP_OT,
  IFNULL(n.ACT_MP_X_OT,0) ACT_MP_X_OT,
  IFNULL(n.ACT_MP_OT,0)+IFNULL(n.ACT_MP_X_OT,0) ACT_MP_ALL_OT,
