...
ioh.*,
ils2.PRODUCT_TYPE,
ils2.PRODUCT_ITEM_CODE AS PRODUCT_ITEM_CODE_STYLE,
ils2.PRODUCT_CATEGORY,
xuw.USER_INISIAL AS USER_ADD,
xux.USER_INISIAL AS USER_MOD
FROM ie_ob_header ioh 
...
LEFT JOIN (
	  SELECT ils.PRODUCT_ITEM_ID, ils.PRODUCT_TYPE, ils.PRODUCT_ITEM_CODE,  ils.PRODUCT_CATEGORY
	  FROM item_list_style ils 
...
ils.PRODUCT_TYPE,
ils.PRODUCT_CATEGORY,
ils.PRODUCT_ITEM_CODE AS PRODUCT_ITEM_CODE_STYLE,
xuw.USER_INISIAL AS USER_ADD,
xux.USER_INISIAL AS USER_MOD
FROM ie_ob_header ioh 
LEFT JOIN xref_user_web xuw ON xuw.USER_ID = ioh.OB_ADD_ID
